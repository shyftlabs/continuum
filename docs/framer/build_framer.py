...
# Stamped into the output so a test can tell whether this file was regenerated
# after the last edit to index.html. Hashing the whole source, not the extracted
# body: a change the generator happens to ignore today may not be ignored
# tomorrow, and "regenerate after any edit" is a rule people can follow.
