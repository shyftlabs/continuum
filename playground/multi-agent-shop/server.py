"""
Workflow Shop MCP server — same products as local-shop, port 8890.
...
if __name__ == "__main__":
    ...
    print("Workflow Shop MCP server running at http://localhost:8890/mcp")
